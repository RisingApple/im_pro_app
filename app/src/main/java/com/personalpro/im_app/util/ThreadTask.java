...
public class ThreadTask {
    ...
    private ThreadTask() {
        ...
        dbThreadQueue = new PriorityBlockingQueue<>(dbThreadCount, taskCompare);
        netThreadQueue = new PriorityBlockingQueue<>(netThreadCount, taskCompare);
        otherThreadQueue = new PriorityBlockingQueue<>(dbThreadCount, taskCompare);
